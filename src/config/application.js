...
const appConfig = {
  ...
  bot: {
    ...botConfig,
    token: process.env.MTQ5MzI5MDc4NzkyMzAzODQ1OQ.GE0QnA.GNRpqHhYBFgsbnlCzOh5wFla6brOs_4eUeHyCw || process.env.TOKEN,
    clientId: process.env.1493290787923038459,
    guildId: process.env.1493268405237579817,
